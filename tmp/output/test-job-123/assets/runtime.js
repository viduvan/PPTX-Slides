...
(function () {
  ...
  ready(function () {
     ...
     *   SCRIPT   — large speaker notes (Speaker script)
    ...
    function openPresenterWindow() {
      ...
      if (!presenterWin) {
        alert('Please allow popups for presenter view');
        return;
      }
...
(function(){
  ...
  function update(n) {
    ...
    notesBody.innerHTML = note || '<span class="empty">(No speaker notes for this slide)</span>';
  ...
  notesBody.innerHTML = slideMeta[idx].notes || '<span class="empty">(No speaker notes for this slide)</span>';
